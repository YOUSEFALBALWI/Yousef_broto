        ...
        <div id="home" className="flex w-full h-screen flex-col md:flex-row gap-5 items-center justify-center text-white relative">
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                <div className="flex flex-col w-full mt-8">
                    ...
                    <p className="text-md font-light text-gray-400 ">Enthusiastic and motivated self-learning in Information Technology. Interested in exploring about Computer Network, and Web Development and Mobile Application Development . Now I am looking for more experience in my field.</p>
                </div>
                ...
                <ul className='flex mt-2 gap-4 items-center'>
                   <li>
                        <a href='https://github.com/EHAB7k' rel="noreferrer" target="_blank"><FontAwesomeIcon size='2xl' icon={faGithub} /></a>
                   </li> 
                    {/* <li>
                        <a href='https://instagram.com/damaasth' rel="noreferrer" target="_blank"><FontAwesomeIcon size='2xl' icon={faInstagram} /></a>
                    </li> */}
                    <li>
                        <a href='https://www.linkedin.com/in/ehabhakami/' rel="noreferrer" target="_blank"><FontAwesomeIcon size='2xl' icon={faLinkedinIn} /></a>
                    </li>
                    <li>
                        <a href='https://wa.me/+966550199599' rel="noreferrer" target="_blank"><FontAwesomeIcon size='2xl' icon={faWhatsapp} /></a>
                    </li>
                </ul>
            </div>
